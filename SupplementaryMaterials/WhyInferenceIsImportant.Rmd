...
library(reticulate)
use_python("C:/Users/steph/anaconda3/python.exe")
...
- Tests can compare **effect size** (averages), **variance**, **goodness of fit**, **distribution assumptions**, or **Independence** 
...
$$\alpha/2 = P(x \le Lower\ CI),\ and,\ \alpha/2 = P(upper\ CI \ge x \ge \infty)$$
...
$$\alpha = P(upper\ CI \ge x \ge \infty)$$
